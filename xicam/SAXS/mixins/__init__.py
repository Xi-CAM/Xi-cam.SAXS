...
class CompareGUIPlugin(BaseSAXSGUIPlugin):
    ...
    def __init__(self):
        ...
        stages = {'Compare': GUILayout(self.comparemultiview, top=self.reducetoolbar,
...
class MaskGUIPlugin(BaseSAXSGUIPlugin):
    ...
    def __init__(self):
        ...
        stages = {'Mask': GUILayout(self.masktabview, right=self.maskeditor, top=self.masktoolbar)}
        self.stages.update(**stages)
...
class TemporarySAXSGUIPlugin(BaseSAXSGUIPlugin):
    name = 'TemporarySAXS'
    ...
    def __init__(self):
        ...
        from xicam.SAXS.widgets.SAXSToolbar import SAXSToolbarRaw, SAXSToolbarMask, SAXSToolbarReduce
        from xicam.SAXS.widgets.XPCSToolbar import XPCSToolBar
        # super(TemporarySAXSGUIPlugin, self).__init__()
